...
\midrule
\textit{Correcting faulty code}   &  no  & no &    \\
\textit{Improving existing code}   &  no   &  no &     \\
\textit{Generating new code}   &  no   & no &    \\
\textit{Layout and formatting}  &  no   & no &     \\
\textit{Text correction}   &  little  & no &    \\
